...
- **Add: plan-aware long-context configuration (Issue #24)** — new `provider.plan` (default `"pro"`) and `provider.longContextExtraUsage` replace the incorrect model id behavior for opting in to 1M context size.
